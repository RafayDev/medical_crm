...
<div class="row mt-3">
    ...
    <div class="col-md-3">
        <div class="box bg-light">
            <a href="/category-type-products/{{$category->id}}/{{$category_type->id}}"><img
                    src="{{asset('storage/types/'.$category_type->image)}}"
                    style="object-fit: contain; height: 300px;  width: 200px;"></a>
            <div class="box-body">
